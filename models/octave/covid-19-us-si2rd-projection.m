...
% DESCRIPTION
%
%    covid-19-us-si2rd-projection computes a projection for the 
%    progression of covid-19 in the United States using the SI2RD 
%    model. 
%
% AUTHOR
%
...
x_data = csvread('../../data/covid-19/jhu/us/covid-19-us-infections-recoveries-deaths-jhu-20200502-df78742.csv',1,0);
...
p = [1/5.7 0.0001 1/17 1/21 0.0035];
...
print -dpng covid-19-us-si2rd-projection-jhu-20200502-df78742.png
